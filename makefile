...
M_OBJ = $(M_PATH_LEX)/lex.o $(M_PATH_PRSR)/parser.o $(M_PATH)/parser.o $(M_PATH)/s_exec.o $(M_PATH)/s_machine.o $(C_PATH)/code_gen.o $(M_PATH_F_LEX)/format_lexer.o $(M_PATH_F_PRSR)/format_parser.o $(C_PATH)/schema.o
...
$(M_PATH_F_LEX)/format_lex.c: $(M_PATH_F_LEX)/format_lexer.lex $(M_PATH_F_PRSR)/format_parser.h
	flex -o $(M_PATH_F_LEX)/format_lexer.c $(M_PATH_F_LEX)/format_lexer.lex -Pformat
