...
%token CHAR	
 INT REAL STRING BOOL STRUCT VECTOR OF TYPE VAR CONST FUNC TOINT TOREAL F_BEGIN F_END REL_OP EQ NE LT LE GT GE IN LOG_OP AND OR NOT IF THEN ELSE ELSIF ENDIF WHILE DO ENDWHILE FOR TO ENDFOR FOREACH ENDFOREACH RETURN READ RD WRITE WR ASSIGN ERROR INTCONST REALCONST CHARCONST STRCONST BOOLCONST ID TRUE FALSE
